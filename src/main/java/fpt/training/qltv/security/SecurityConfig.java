    ...
    public SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/v1/borrows/**").hasRole("USER")
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/borrows/my").hasRole("USER")
                .requestMatchers("/api/v1/reviews/**").hasRole("USER")

                .requestMatchers("/api/v1/profile/**").hasAnyRole("USER", "ADMIN")

                .requestMatchers("/api/v1/users/**").hasRole("ADMIN")
                .requestMatchers("/api/v1/borrows").hasRole("ADMIN")
